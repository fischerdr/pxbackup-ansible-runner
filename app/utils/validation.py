...
class CreateClusterRequest(BaseModel):
    ...
    force: bool = Field(
        False,
        description="If true, recreate the cluster even if it already exists"
    )
    ...
    def validate_name(cls, v):
        ...
        if not re.match(r'^[a-z0-9][a-z0-9-]*[a-z0-9]$', v):
            raise ValueError("Cluster name must start and end with alphanumeric character and contain only lowercase letters, numbers, and hyphens")
        return v
    ...
    def validate_service_account(cls, v):
        ...
        if not re.match(r'^[a-z0-9][a-z0-9-]*[a-z0-9]$', v):
            raise ValueError("Service account must start and end with alphanumeric character and contain only lowercase letters, numbers, and hyphens")
        return v
    ...
    def validate_namespace(cls, v):
        ...
        if not re.match(r'^[a-z0-9][a-z0-9-]*[a-z0-9]$', v):
            raise ValueError("Namespace must start and end with alphanumeric character and contain only lowercase letters, numbers, and hyphens")
        return v
